...
def generate_timeline_image(data, output_file):
    ...
    # Move x-axis labels to the middle line
    ax.tick_params(axis='x', direction='out', pad=-20)  # Move labels closer to the middle line
...
if __name__ == "__main__":
    ...
    input_file = "timeline_data.json"  # Replace with your JSON file
    output_file = "timeline_output.png"

    with open(input_file, 'r') as file:
        data = json.load(file)

    # Generate timeline image
    generate_timeline_image(data, output_file)
    print(f"Timeline image saved to {output_file}")
